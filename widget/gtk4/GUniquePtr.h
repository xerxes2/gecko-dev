...
struct GFreeDeleter {
  ...
  void operator()(GdkCrossingEvent* aPtr) const {
    gdk_event_unref((GdkEvent*)aPtr);
  }
  void operator()(GdkKeyEvent* aPtr) const { gdk_event_unref((GdkEvent*)aPtr); }
  void operator()(GdkEvent* aPtr) const { gdk_event_unref(aPtr); }
