...
KEY_MAP_GTK(Alt, GDK_KEY_Alt_L)
KEY_MAP_GTK(Alt, GDK_KEY_Alt_R)
KEY_MAP_GTK(Alt, GDK_KEY_Meta_L)
KEY_MAP_GTK(Alt, GDK_KEY_Meta_R)
KEY_MAP_ANDROID(Alt, AKEYCODE_ALT_LEFT)
KEY_MAP_ANDROID(Alt, AKEYCODE_ALT_RIGHT)

// AltGraph
KEY_MAP_GTK     (AltGraph, GDK_KEY_Mode_switch /* same as GDK_kana_switch,
...
// GDK_Shift_Lock.
KEY_MAP_GTK(AltGraph, GDK_KEY_ISO_Level3_Shift)
KEY_MAP_GTK(AltGraph, GDK_KEY_ISO_Level3_Latch)
KEY_MAP_GTK(AltGraph, GDK_KEY_ISO_Level3_Lock)
KEY_MAP_GTK(AltGraph, GDK_KEY_ISO_Level5_Shift)
KEY_MAP_GTK(AltGraph, GDK_KEY_ISO_Level5_Latch)
KEY_MAP_GTK(AltGraph, GDK_KEY_ISO_Level5_Lock)

// CapsLock
KEY_MAP_WIN(CapsLock, VK_CAPITAL)
KEY_MAP_COCOA(CapsLock, kVK_CapsLock)
KEY_MAP_GTK(CapsLock, GDK_KEY_Caps_Lock)
...
KEY_MAP_GTK(Control, GDK_KEY_Control_L)
KEY_MAP_GTK(Control, GDK_KEY_Control_R)
...
KEY_MAP_GTK(Meta, GDK_KEY_Super_L)
KEY_MAP_GTK(Meta, GDK_KEY_Super_R)
KEY_MAP_GTK(Meta, GDK_KEY_Hyper_L)
KEY_MAP_GTK(Meta, GDK_KEY_Hyper_R)
KEY_MAP_ANDROID(Meta, AKEYCODE_META_LEFT)
KEY_MAP_ANDROID(Meta, AKEYCODE_META_RIGHT)

// NumLock
KEY_MAP_WIN(NumLock, VK_NUMLOCK)
KEY_MAP_GTK(NumLock, GDK_KEY_Num_Lock)
KEY_MAP_ANDROID(NumLock, AKEYCODE_NUM_LOCK)

// ScrollLock
KEY_MAP_WIN(ScrollLock, VK_SCROLL)
KEY_MAP_GTK(ScrollLock, GDK_KEY_Scroll_Lock)
...
KEY_MAP_GTK(Shift, GDK_KEY_Shift_L)
KEY_MAP_GTK(Shift, GDK_KEY_Shift_R)
KEY_MAP_GTK(Shift, GDK_KEY_Shift_Lock)  // Let's treat as Shift key (bug 769159)
...
KEY_MAP_GTK(Enter, GDK_KEY_Return)
KEY_MAP_GTK(Enter, GDK_KEY_KP_Enter)
KEY_MAP_GTK(Enter, GDK_KEY_ISO_Enter)
KEY_MAP_GTK(Enter, GDK_KEY_3270_Enter)
...
KEY_MAP_GTK(Tab, GDK_KEY_Tab)
KEY_MAP_GTK(Tab, GDK_KEY_ISO_Left_Tab)  // Shift+Tab
KEY_MAP_GTK(Tab, GDK_KEY_KP_Tab)
...
KEY_MAP_GTK(Backspace, GDK_KEY_BackSpace)
 ...
 ******************************************************************************/
// BrightnessDown
KEY_MAP_GTK(BrightnessDown, GDK_KEY_MonBrightnessDown)
KEY_MAP_ANDROID(BrightnessDown, AKEYCODE_BRIGHTNESS_DOWN)

// BrightnessUp
KEY_MAP_GTK(BrightnessUp, GDK_KEY_MonBrightnessUp)
KEY_MAP_ANDROID(BrightnessUp, AKEYCODE_BRIGHTNESS_UP)

// Eject
KEY_MAP_GTK(Eject, GDK_KEY_Eject)
KEY_MAP_ANDROID(Eject, AKEYCODE_MEDIA_EJECT)

// LogOff
KEY_MAP_GTK(LogOff, GDK_KEY_LogOff)

// Power
KEY_MAP_ANDROID(Power, AKEYCODE_POWER)

// PowerOff
KEY_MAP_GTK(PowerOff, GDK_KEY_PowerDown)
KEY_MAP_GTK(PowerOff, GDK_KEY_PowerOff)

// PrintScreen
KEY_MAP_WIN(PrintScreen, VK_SNAPSHOT)
KEY_MAP_GTK(PrintScreen, GDK_KEY_3270_PrintScreen)
KEY_MAP_GTK(PrintScreen, GDK_KEY_Print)
KEY_MAP_GTK(PrintScreen, GDK_KEY_Sys_Req)
KEY_MAP_ANDROID(PrintScreen, AKEYCODE_SYSRQ)

// Hibernate
KEY_MAP_GTK(Hibernate, GDK_KEY_Hibernate)

// Standby
KEY_MAP_WIN(Standby, VK_SLEEP)
KEY_MAP_GTK(Standby, GDK_KEY_Standby)
KEY_MAP_GTK(Standby, GDK_KEY_Suspend)
KEY_MAP_GTK(Standby, GDK_KEY_Sleep)
KEY_MAP_ANDROID(Standby, AKEYCODE_SLEEP)

// WakeUp
KEY_MAP_GTK(WakeUp, GDK_KEY_WakeUp)
 ...
 ******************************************************************************/
// AllCandidates
KEY_MAP_GTK(AllCandidates, GDK_KEY_MultipleCandidate)  // OADG 109, Zen Koho

// Alphanumeric
KEY_MAP_WIN_JPN(Alphanumeric, VK_OEM_ATTN)
KEY_MAP_GTK(Alphanumeric, GDK_KEY_Eisu_Shift)
KEY_MAP_GTK(Alphanumeric, GDK_KEY_Eisu_toggle)

// CodeInput
KEY_MAP_GTK(CodeInput, GDK_KEY_Codeinput)  // OADG 109, Kanji Bangou

// Compose
KEY_MAP_GTK(Compose, GDK_KEY_Multi_key)  // "Multi Key" is "Compose key" on X

// Convert
KEY_MAP_WIN(Convert, VK_CONVERT)
KEY_MAP_GTK(Convert, GDK_KEY_Henkan)
KEY_MAP_ANDROID(Convert, AKEYCODE_HENKAN)

// Dead
KEY_MAP_GTK(Dead, GDK_KEY_dead_grave)
KEY_MAP_GTK(Dead, GDK_KEY_dead_acute)
KEY_MAP_GTK(Dead, GDK_KEY_dead_circumflex)
KEY_MAP_GTK(Dead, GDK_KEY_dead_tilde)  // Same as GDK_dead_perispomeni
KEY_MAP_GTK(Dead, GDK_KEY_dead_macron)
KEY_MAP_GTK(Dead, GDK_KEY_dead_breve)
KEY_MAP_GTK(Dead, GDK_KEY_dead_abovedot)
KEY_MAP_GTK(Dead, GDK_KEY_dead_diaeresis)
KEY_MAP_GTK(Dead, GDK_KEY_dead_abovering)
KEY_MAP_GTK(Dead, GDK_KEY_dead_doubleacute)
KEY_MAP_GTK(Dead, GDK_KEY_dead_caron)
KEY_MAP_GTK(Dead, GDK_KEY_dead_cedilla)
KEY_MAP_GTK(Dead, GDK_KEY_dead_ogonek)
KEY_MAP_GTK(Dead, GDK_KEY_dead_iota)
KEY_MAP_GTK(Dead, GDK_KEY_dead_voiced_sound)
KEY_MAP_GTK(Dead, GDK_KEY_dead_semivoiced_sound)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowdot)
KEY_MAP_GTK(Dead, GDK_KEY_dead_hook)
KEY_MAP_GTK(Dead, GDK_KEY_dead_horn)
KEY_MAP_GTK(Dead, GDK_KEY_dead_stroke)
KEY_MAP_GTK(Dead, GDK_KEY_dead_abovecomma)          // Same as GDK_dead_psili
KEY_MAP_GTK(Dead, GDK_KEY_dead_abovereversedcomma)  // Same as GDK_dead_dasia
KEY_MAP_GTK(Dead, GDK_KEY_dead_doublegrave)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowring)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowmacron)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowcircumflex)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowtilde)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowbreve)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowdiaeresis)
KEY_MAP_GTK(Dead, GDK_KEY_dead_invertedbreve)
KEY_MAP_GTK(Dead, GDK_KEY_dead_belowcomma)
KEY_MAP_GTK(Dead, GDK_KEY_dead_currency)
KEY_MAP_GTK(Dead, GDK_KEY_dead_a)
KEY_MAP_GTK(Dead, GDK_KEY_dead_A)
KEY_MAP_GTK(Dead, GDK_KEY_dead_e)
KEY_MAP_GTK(Dead, GDK_KEY_dead_E)
KEY_MAP_GTK(Dead, GDK_KEY_dead_i)
KEY_MAP_GTK(Dead, GDK_KEY_dead_I)
KEY_MAP_GTK(Dead, GDK_KEY_dead_o)
KEY_MAP_GTK(Dead, GDK_KEY_dead_O)
KEY_MAP_GTK(Dead, GDK_KEY_dead_u)
KEY_MAP_GTK(Dead, GDK_KEY_dead_U)
KEY_MAP_GTK(Dead, GDK_KEY_dead_small_schwa)
KEY_MAP_GTK(Dead, GDK_KEY_dead_capital_schwa)
KEY_MAP_GTK(Dead, GDK_KEY_dead_greek)

// FinalMode
KEY_MAP_WIN(FinalMode, VK_FINAL)

// GroupFirst
KEY_MAP_GTK(GroupFirst, GDK_KEY_ISO_First_Group)

// GroupLast
KEY_MAP_GTK(GroupLast, GDK_KEY_ISO_Last_Group)

// GroupNext
KEY_MAP_GTK(GroupNext, GDK_KEY_ISO_Next_Group)
KEY_MAP_ANDROID(GroupNext, AKEYCODE_LANGUAGE_SWITCH)

// GroupPrevious
KEY_MAP_GTK(GroupPrevious, GDK_KEY_ISO_Prev_Group)
...
KEY_MAP_GTK(NonConvert, GDK_KEY_Muhenkan)
KEY_MAP_ANDROID(NonConvert, AKEYCODE_MUHENKAN)

// PreviousCandidate
KEY_MAP_GTK(PreviousCandidate, GDK_KEY_PreviousCandidate)  // OADG 109, Mae Koho

// Process
KEY_MAP_WIN(Process, VK_PROCESSKEY)

// SingleCandidate
KEY_MAP_GTK(SingleCandidate, GDK_KEY_SingleCandidate)
...
KEY_MAP_GTK(Hankaku, GDK_KEY_Hankaku)

// Hiragana
KEY_MAP_WIN_JPN(Hiragana, VK_OEM_COPY)
KEY_MAP_GTK(Hiragana, GDK_KEY_Hiragana)

// HiraganaKatakana
KEY_MAP_GTK(HiraganaKatakana, GDK_KEY_Hiragana_Katakana)
...
KEY_MAP_GTK(KanaMode, GDK_KEY_Kana_Lock)
KEY_MAP_GTK(KanaMode, GDK_KEY_Kana_Shift)

// KanjiMode
KEY_MAP_WIN_JPN(KanjiMode, VK_KANJI /* same as VK_HANJA */)
KEY_MAP_COCOA(KanjiMode, kVK_JIS_Kana)  // Kana key opens IME
KEY_MAP_GTK(KanjiMode, GDK_KEY_Kanji)       // Typically, Alt + Hankaku/Zenkaku key
...
KEY_MAP_GTK(Katakana, GDK_KEY_Katakana)

// Romaji
KEY_MAP_WIN_JPN(Romaji, VK_OEM_BACKTAB)
KEY_MAP_GTK(Romaji, GDK_KEY_Romaji)

// Zenkaku
KEY_MAP_WIN_JPN(Zenkaku, VK_OEM_ENLW)
KEY_MAP_GTK(Zenkaku, GDK_KEY_Zenkaku)

// ZenkakuHankaku
KEY_MAP_GTK(ZenkakuHankaku, GDK_KEY_Zenkaku_Hankaku)
...
KEY_MAP_GTK(F1, GDK_KEY_F1)
KEY_MAP_GTK(F1, GDK_KEY_KP_F1)
KEY_MAP_ANDROID(F1, AKEYCODE_F1)

// F2
KEY_MAP_WIN(F2, VK_F2)
KEY_MAP_COCOA(F2, kVK_F2)
KEY_MAP_GTK(F2, GDK_KEY_F2)
KEY_MAP_GTK(F2, GDK_KEY_KP_F2)
KEY_MAP_ANDROID(F2, AKEYCODE_F2)

// F3
KEY_MAP_WIN(F3, VK_F3)
KEY_MAP_COCOA(F3, kVK_F3)
KEY_MAP_GTK(F3, GDK_KEY_F3)
KEY_MAP_GTK(F3, GDK_KEY_KP_F3)
KEY_MAP_ANDROID(F3, AKEYCODE_F3)

// F4
KEY_MAP_WIN(F4, VK_F4)
KEY_MAP_COCOA(F4, kVK_F4)
KEY_MAP_GTK(F4, GDK_KEY_F4)
KEY_MAP_GTK(F4, GDK_KEY_KP_F4)
KEY_MAP_ANDROID(F4, AKEYCODE_F4)

// F5
KEY_MAP_WIN(F5, VK_F5)
KEY_MAP_COCOA(F5, kVK_F5)
KEY_MAP_GTK(F5, GDK_KEY_F5)
KEY_MAP_ANDROID(F5, AKEYCODE_F5)

// F6
KEY_MAP_WIN(F6, VK_F6)
KEY_MAP_COCOA(F6, kVK_F6)
KEY_MAP_GTK(F6, GDK_KEY_F6)
KEY_MAP_ANDROID(F6, AKEYCODE_F6)

// F7
KEY_MAP_WIN(F7, VK_F7)
KEY_MAP_COCOA(F7, kVK_F7)
KEY_MAP_GTK(F7, GDK_KEY_F7)
KEY_MAP_ANDROID(F7, AKEYCODE_F7)

// F8
KEY_MAP_WIN(F8, VK_F8)
KEY_MAP_COCOA(F8, kVK_F8)
KEY_MAP_GTK(F8, GDK_KEY_F8)
KEY_MAP_ANDROID(F8, AKEYCODE_F8)

// F9
KEY_MAP_WIN(F9, VK_F9)
KEY_MAP_COCOA(F9, kVK_F9)
KEY_MAP_GTK(F9, GDK_KEY_F9)
KEY_MAP_ANDROID(F9, AKEYCODE_F9)

// F10
KEY_MAP_WIN(F10, VK_F10)
KEY_MAP_COCOA(F10, kVK_F10)
KEY_MAP_GTK(F10, GDK_KEY_F10)
KEY_MAP_ANDROID(F10, AKEYCODE_F10)

// F11
KEY_MAP_WIN(F11, VK_F11)
KEY_MAP_COCOA(F11, kVK_F11)
KEY_MAP_GTK(F11, GDK_KEY_F11 /* same as GDK_L1 */)
KEY_MAP_ANDROID(F11, AKEYCODE_F11)

// F12
KEY_MAP_WIN(F12, VK_F12)
KEY_MAP_COCOA(F12, kVK_F12)
KEY_MAP_GTK(F12, GDK_KEY_F12 /* same as GDK_L2 */)
KEY_MAP_ANDROID(F12, AKEYCODE_F12)

// F13
KEY_MAP_WIN(F13, VK_F13)
KEY_MAP_COCOA(F13, kVK_F13)
KEY_MAP_GTK(F13, GDK_KEY_F13 /* same as GDK_L3 */)

// F14
KEY_MAP_WIN(F14, VK_F14)
KEY_MAP_COCOA(F14, kVK_F14)
KEY_MAP_GTK(F14, GDK_KEY_F14 /* same as GDK_L4 */)

// F15
KEY_MAP_WIN(F15, VK_F15)
KEY_MAP_COCOA(F15, kVK_F15)
KEY_MAP_GTK(F15, GDK_KEY_F15 /* same as GDK_L5 */)

// F16
KEY_MAP_WIN(F16, VK_F16)
KEY_MAP_COCOA(F16, kVK_F16)
KEY_MAP_GTK(F16, GDK_KEY_F16 /* same as GDK_L6 */)

// F17
KEY_MAP_WIN(F17, VK_F17)
KEY_MAP_COCOA(F17, kVK_F17)
KEY_MAP_GTK(F17, GDK_KEY_F17 /* same as GDK_L7 */)

// F18
KEY_MAP_WIN(F18, VK_F18)
KEY_MAP_COCOA(F18, kVK_F18)
KEY_MAP_GTK(F18, GDK_KEY_F18 /* same as GDK_L8 */)

// F19
KEY_MAP_WIN(F19, VK_F19)
KEY_MAP_COCOA(F19, kVK_F19)
KEY_MAP_GTK(F19, GDK_KEY_F19 /* same as GDK_L9 */)

// F20
KEY_MAP_WIN(F20, VK_F20)
KEY_MAP_GTK(F20, GDK_KEY_F20 /* same as GDK_L10 */)

// F21
KEY_MAP_WIN(F21, VK_F21)
KEY_MAP_GTK(F21, GDK_KEY_F21 /* same as GDK_R1 */)

// F22
KEY_MAP_WIN(F22, VK_F22)
KEY_MAP_GTK(F22, GDK_KEY_F22 /* same as GDK_R2 */)

// F23
KEY_MAP_WIN(F23, VK_F23)
KEY_MAP_GTK(F23, GDK_KEY_F23 /* same as GDK_R3 */)

// F24
KEY_MAP_WIN(F24, VK_F24)
KEY_MAP_GTK(F24, GDK_KEY_F24 /* same as GDK_R4 */)

// F25
KEY_MAP_GTK(F25, GDK_KEY_F25 /* same as GDK_R5 */)

// F26
KEY_MAP_GTK(F26, GDK_KEY_F26 /* same as GDK_R6 */)

// F27
KEY_MAP_GTK(F27, GDK_KEY_F27 /* same as GDK_R7 */)

// F28
KEY_MAP_GTK(F28, GDK_KEY_F28 /* same as GDK_R8 */)

// F29
KEY_MAP_GTK(F29, GDK_KEY_F29 /* same as GDK_R9 */)

// F30
KEY_MAP_GTK(F30, GDK_KEY_F30 /* same as GDK_R10 */)

// F31
KEY_MAP_GTK(F31, GDK_KEY_F31 /* same as GDK_R11 */)

// F32
KEY_MAP_GTK(F32, GDK_KEY_F32 /* same as GDK_R12 */)

// F33
KEY_MAP_GTK(F33, GDK_KEY_F33 /* same as GDK_R13 */)

// F34
KEY_MAP_GTK(F34, GDK_KEY_F34 /* same as GDK_R14 */)

// F35
KEY_MAP_GTK(F35, GDK_KEY_F35 /* same as GDK_R15 */)
...
KEY_MAP_GTK(MediaStop, GDK_KEY_AudioStop)
...
KEY_MAP_GTK(MediaTrackNext, GDK_KEY_AudioNext)
...
KEY_MAP_GTK(Save, GDK_KEY_Save)

// SpellCheck
KEY_MAP_WIN_CMD(SpellCheck, APPCOMMAND_SPELL_CHECK)
KEY_MAP_GTK(SpellCheck, GDK_KEY_Spell)
...
KEY_MAP_GTK(AudioVolumeDown, GDK_KEY_AudioLowerVolume)
...
KEY_MAP_GTK(AudioVolumeUp, GDK_KEY_AudioRaiseVolume)
...
KEY_MAP_GTK(AudioVolumeMute, GDK_KEY_AudioMute)
 ...
 ******************************************************************************/
// LaunchCalculator
KEY_MAP_GTK(LaunchCalculator, GDK_KEY_Calculator)
KEY_MAP_ANDROID(LaunchCalculator, AKEYCODE_CALCULATOR)

// LaunchCalendar
KEY_MAP_GTK(LaunchCalendar, GDK_KEY_Calendar)
...
KEY_MAP_GTK(LaunchMail, GDK_KEY_Mail)
...
KEY_MAP_GTK(LaunchMediaPlayer, GDK_KEY_CD)
KEY_MAP_GTK(LaunchMediaPlayer, GDK_KEY_Video)
KEY_MAP_GTK(LaunchMediaPlayer, GDK_KEY_AudioMedia)

// LaunchMusicPlayer
KEY_MAP_GTK(LaunchMusicPlayer, GDK_KEY_Music)
KEY_MAP_ANDROID(LaunchMusicPlayer, AKEYCODE_MUSIC)

// LaunchMyComputer
KEY_MAP_GTK(LaunchMyComputer, GDK_KEY_MyComputer)
KEY_MAP_GTK(LaunchMyComputer, GDK_KEY_Explorer)

// LaunchScreenSaver
KEY_MAP_GTK(LaunchScreenSaver, GDK_KEY_ScreenSaver)

// LaunchSpreadsheet
KEY_MAP_GTK(LaunchSpreadsheet, GDK_KEY_Excel)

// LaunchWebBrowser
KEY_MAP_GTK(LaunchWebBrowser, GDK_KEY_WWW)
KEY_MAP_ANDROID(LaunchWebBrowser, AKEYCODE_EXPLORER)

// LaunchWebCam
KEY_MAP_GTK(LaunchWebCam, GDK_KEY_WebCam)

// LaunchWordProcessor
KEY_MAP_GTK(LaunchWordProcessor, GDK_KEY_Word)

// LaunchApplication1
KEY_MAP_WIN(LaunchApplication1, VK_LAUNCH_APP1)
KEY_MAP_WIN_CMD(LaunchApplication1, APPCOMMAND_LAUNCH_APP1)
KEY_MAP_GTK(LaunchApplication1, GDK_KEY_Launch0)

// LaunchApplication2
KEY_MAP_WIN(LaunchApplication2, VK_LAUNCH_APP2)
KEY_MAP_WIN_CMD(LaunchApplication2, APPCOMMAND_LAUNCH_APP2)
KEY_MAP_GTK(LaunchApplication2, GDK_KEY_Launch1)

// LaunchApplication3
KEY_MAP_GTK(LaunchApplication3, GDK_KEY_Launch2)

// LaunchApplication4
KEY_MAP_GTK(LaunchApplication4, GDK_KEY_Launch3)

// LaunchApplication5
KEY_MAP_GTK(LaunchApplication5, GDK_KEY_Launch4)

// LaunchApplication6
KEY_MAP_GTK(LaunchApplication6, GDK_KEY_Launch5)

// LaunchApplication7
KEY_MAP_GTK(LaunchApplication7, GDK_KEY_Launch6)

// LaunchApplication8
KEY_MAP_GTK(LaunchApplication8, GDK_KEY_Launch7)

// LaunchApplication9
KEY_MAP_GTK(LaunchApplication9, GDK_KEY_Launch8)

// LaunchApplication10
KEY_MAP_GTK(LaunchApplication10, GDK_KEY_Launch9)

// LaunchApplication11
KEY_MAP_GTK(LaunchApplication11, GDK_KEY_LaunchA)

// LaunchApplication12
KEY_MAP_GTK(LaunchApplication12, GDK_KEY_LaunchB)

// LaunchApplication13
KEY_MAP_GTK(LaunchApplication13, GDK_KEY_LaunchC)

// LaunchApplication14
KEY_MAP_GTK(LaunchApplication14, GDK_KEY_LaunchD)

// LaunchApplication15
KEY_MAP_GTK(LaunchApplication15, GDK_KEY_LaunchE)

// LaunchApplication16
KEY_MAP_GTK(LaunchApplication16, GDK_KEY_LaunchF)
...
KEY_MAP_GTK(BrowserBack, GDK_KEY_Back)
...
KEY_MAP_GTK(BrowserForward, GDK_KEY_Forward)
...
KEY_MAP_GTK(BrowserStop, GDK_KEY_Stop)
...
// ColorF0Red
KEY_MAP_GTK(ColorF0Red, GDK_KEY_Red)
KEY_MAP_ANDROID(ColorF0Red, AKEYCODE_PROG_RED)

// ColorF1Green
KEY_MAP_GTK(ColorF1Green, GDK_KEY_Green)
KEY_MAP_ANDROID(ColorF1Green, AKEYCODE_PROG_GREEN)

// ColorF2Yellow
KEY_MAP_GTK(ColorF2Yellow, GDK_KEY_Yellow)
KEY_MAP_ANDROID(ColorF2Yellow, AKEYCODE_PROG_YELLOW)

// ColorF3Blue
KEY_MAP_GTK(ColorF3Blue, GDK_KEY_Blue)
...
// Dimmer
KEY_MAP_GTK(Dimmer, GDK_KEY_BrightnessAdjust)
...
// RandomToggle
KEY_MAP_GTK(RandomToggle, GDK_KEY_AudioRandomPlay)
...
// Subtitle
KEY_MAP_GTK(Subtitle, GDK_KEY_Subtitle)

// Teletext
KEY_MAP_ANDROID(Teletext, AKEYCODE_TV_TELETEXT)

// VideoModeNext
KEY_MAP_GTK(VideoModeNext, GDK_KEY_Next_VMode)
